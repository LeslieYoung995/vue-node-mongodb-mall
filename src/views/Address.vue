<template>
  <div>
          ...
          <div class="addr-list-wrap">
            ...
            <div class="shipping-addr-more">
              <a class="addr-more-btn up-down-btn" href="javascript:;" @click="expand"
                 v-bind:class="{'open':this.limit>3 }">
                more
                <i class="i-up-down">
    ...
    <modal :mdShow="mdShowAdd" @close="closeModal">
      <div slot="message">
        <from name="addAddressInfo" class="form-horizontal">
          <div class="form-group">
            <label for="addressInput" class="col-xs-4 col-lg-2 col-md-2 control-label">Consignee</label>
            <div class="col-xs-12">
              <input type="text" class="form-control" id="addressInput" placeholder="Consignee" v-model="addConsignee">
            </div>
          </div>
          <div class="form-group">
            <label for="addressInput" class="col-xs-4 col-lg-2 col-md-2 control-label">Address</label>
            <div class="col-xs-12">
              <input type="text" class="form-control" id="addressInput" placeholder="AddressInformation"
                     v-model="addNewAddress">
            </div>
          </div>
          <div class="form-group">
            <label for="addressInput" class="col-xs-4 col-lg-2 col-md-2 control-label">PostCode</label>
            <div class="col-xs-12">
              <input type="text" class="form-control" id="addressInput" placeholder="PostCode" v-model="addPostCode">
            </div>
          </div>
          <div class="form-group">
            <label for="addressInput" class="col-xs-4 col-lg-2 col-md-2 control-label">Telephone</label>
            <div class="col-xs-12">
              <input type="text" class="form-control" id="addressInput" placeholder="TelephoneNumber" v-model="addTel">
            </div>
      ...
      <div slot="btnGroup">
        <div class="row">
          <div class="col-lg-6 col-xs-12 col-xs-offset-3 "><a href="javascript:;" class="btn btn--m"
                                                              @click="addAddress">确认</a></div>
          <div class="col-lg-6 col-xs-12 col-xs-offset-3"><a href="javascript:;" class="btn btn--m"
                                                             @click="mdShowAdd=false">取消</a></div>
        </div>
...
<script>
  ...
  export default {
    ...
    computed: {
      addressListFilter() {
        return this.addressList.slice(0, this.limit);  //默认显示条数
      }
    },
    mounted() {
      this.getAddressList();
